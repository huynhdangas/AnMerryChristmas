...
$(function () {
    ...
    animates.step1 = function () {
        ...
        setTimeout(function () {
            $stars
                .addClass("opacity1 bounceInDown")
                .one(animateEvents, animates.step2);
        }, 300);
    };
    ...
    animates.step3 = function () {
        ...
        setTimeout(function () {
            $gift3
                .addClass("opacity1 bounceInDown")
                .one(animateEvents, animates.step4);
        }, 600);
    };
    ...
    animates.step4 = function () {
        $(".j-bigSnow")
            .addClass("bigSnow-smallPos")
            .one(transitionEvents, animates.step5);
    };
            ...
            $loading
                ...
                .one(transitionEvents, function () {
                    if (parseInt(preload.loadedPer) >= 99) {
                        $loading.find(".loading-text").text("Tải hoàn tất");
